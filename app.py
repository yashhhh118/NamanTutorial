...
app.config['SESSION_COOKIE_SECURE'] = os.getenv('FLASK_ENV') == 'production'  # Only send over HTTPS in production
...
def submit_application():
    ...
    file_path = os.path.join(app.config['UPLOAD_FOLDER'], f"{name.replace(' ', '_')}_{timestamp}_{filename}")
...
if __name__ == '__main__':
    # Run Flask Application - uses PORT env var for Render, defaults to 5000 locally
